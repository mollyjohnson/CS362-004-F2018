...
#define FUNCTION_NAME "supplyCount"
...
int main()
{
	...
	for(i = 0; i < 27; i++)
	{
		printf("TEST %d: supply count of card %s\n", i + 1, cardTypeName[i]);
		returnVal = supplyCount(cardType[i], &testGame);
		Assert(returnVal == Game.supplyCount[cardType[i]] , "get supply of card test");
		printf("card supply: %d, expected: %d\n", returnVal, Game.supplyCount[cardType[i]]);
	}	
	...
	printf("TEST 28: current player hand card count doesn't change\n");
	//do game state copy for the test case
	memcpy(&testGame, &Game, sizeof(struct gameState));
	...
	printf("TEST 29: no  cards come from the current player's deck\n");
	//do game state copy for the test case
	memcpy(&testGame, &Game, sizeof(struct gameState));
	cardEffect(smithy, choice1, choice2, choice3, &testGame, handPos, &bonus);
	...
	printf("TEST 30: discard pile stays the same\n");
	//do game state copy for the test case
	memcpy(&testGame, &Game, sizeof(struct gameState));
	cardEffect(smithy, choice1, choice2, choice3, &testGame, handPos, &bonus);
	...
	printf("TEST 31: no state change for things specific to other players (hand count, deck count, discard count\n");
	//do game state copy for the test case
	memcpy(&testGame, &Game, sizeof(struct gameState));
	cardEffect(smithy, choice1, choice2, choice3, &testGame, handPos, &bonus);
	...
	printf("TEST 32: no state change to victory card piles\n");
	//do game state copy for the test case
	memcpy(&testGame, &Game, sizeof(struct gameState));
	cardEffect(smithy, choice1, choice2, choice3, &testGame, handPos, &bonus);
	...
	printf("TEST 34: no state change to kingdom card piles\n");
	//do game state copy for the test case
	memcpy(&testGame, &Game, sizeof(struct gameState));
	...
	printf("TEST 35: played card pile  stays the same\n");
	//do game state copy for the test case
	memcpy(&testGame, &Game, sizeof(struct gameState));
	cardEffect(smithy, choice1, choice2, choice3, &testGame, handPos, &bonus);
	...
	printf("TEST 36: numPlayers does not change\n");
	//do game state copy for the test case
	memcpy(&testGame, &Game, sizeof(struct gameState));
	cardEffect(smithy, choice1, choice2, choice3, &testGame, handPos, &bonus);
	...
	printf("TEST 37: embargoTokens does not change\n");
	//do game state copy for the test case
	memcpy(&testGame, &Game, sizeof(struct gameState));
	cardEffect(smithy, choice1, choice2, choice3, &testGame, handPos, &bonus);
	...
	printf("TEST 38: outpostPlayed does not change\n");
	//do game state copy for the test case
	memcpy(&testGame, &Game, sizeof(struct gameState));
	cardEffect(smithy, choice1, choice2, choice3, &testGame, handPos, &bonus);
	...
	printf("TEST 39: outpostTurn does not change\n");
	//do game state copy for the test case
	memcpy(&testGame, &Game, sizeof(struct gameState));
	cardEffect(smithy, choice1, choice2, choice3, &testGame, handPos, &bonus);
	...
	printf("TEST 40: whoseTurn does not change\n");
	//do game state copy for the test case
	memcpy(&testGame, &Game, sizeof(struct gameState));
	cardEffect(smithy, choice1, choice2, choice3, &testGame, handPos, &bonus);
	...
	printf("TEST 41: phase does not change\n");
	//do game state copy for the test case
	memcpy(&testGame, &Game, sizeof(struct gameState));
	cardEffect(smithy, choice1, choice2, choice3, &testGame, handPos, &bonus);
	...
	printf("TEST 42: numActions does not change\n");
	//do game state copy for the test case
	memcpy(&testGame, &Game, sizeof(struct gameState));
	cardEffect(smithy, choice1, choice2, choice3, &testGame, handPos, &bonus);
	...
	printf("TEST 43: coins does not change\n");
	//do game state copy for the test case
	memcpy(&testGame, &Game, sizeof(struct gameState));
	cardEffect(smithy, choice1, choice2, choice3, &testGame, handPos, &bonus);
	...
	printf("TEST 44: numBuys does not change\n");
	//do game state copy for the test case
	memcpy(&testGame, &Game, sizeof(struct gameState));
	cardEffect(smithy, choice1, choice2, choice3, &testGame, handPos, &bonus);
	...
	printf("TEST 45: discardCount does not change\n");
	//do game state copy for the test case
	memcpy(&testGame, &Game, sizeof(struct gameState));
	cardEffect(smithy, choice1, choice2, choice3, &testGame, handPos, &bonus);
